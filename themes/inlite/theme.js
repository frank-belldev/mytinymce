...
var inlite = (function () {
  ...
  var $_gijdng16rjfcjbcok = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_989kby16vjfcjbcox.fromClientRect(clientRect)) : null;
  };
  var $_e8c7z116ujfcjbcou = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_4wnjwo16tjfcjbcoq.result(predicateIds[i].id, $_e8c7z116ujfcjbcou.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_4wnjwo16tjfcjbcoq.result(predicateIds[x].id, $_e8c7z116ujfcjbcou.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_4wnjwo16tjfcjbcoq.result(id, $_e8c7z116ujfcjbcou.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_4wnjwo16tjfcjbcoq.result(id, $_e8c7z116ujfcjbcou.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_7uw29l174jfcjbcpk.isArray(value)) {
      return value;
    } else if ($_7uw29l174jfcjbcpk.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_7uw29l174jfcjbcpk.isBoolean(value)) {
  ...
  var $_eyr5eo173jfcjbcph = {
    getStringOr: getByTypeOr($_7uw29l174jfcjbcpk.isString),
    getBoolOr: getByTypeOr($_7uw29l174jfcjbcpk.isBoolean),
    getNumberOr: getByTypeOr($_7uw29l174jfcjbcpk.isNumber),
    getHandlerOr: getByTypeOr($_7uw29l174jfcjbcpk.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_7uw29l174jfcjbcpk.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_989kby16vjfcjbcox.toClientRect(targetRect),
        contentAreaRect: $_989kby16vjfcjbcox.toClientRect(contentAreaRect),
        panelRect: $_989kby16vjfcjbcox.toClientRect(panelRect)
      });
      return $_989kby16vjfcjbcox.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_eyr5eo173jfcjbcph.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_eyr5eo173jfcjbcph.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_eyr5eo173jfcjbcph.getHandlerOr(editor, 'inline_toolbar_position_handler', $_e34w8y175jfcjbcpo.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_g2wa0r170jfcjbcp9.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_ai8lh8171jfcjbcpd.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_ai8lh8171jfcjbcpd.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_cl1v5v16zjfcjbcp6 = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_gijdng16rjfcjbcok.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_g0b1cz16wjfcjbcp0.fromContextToolbars(toolbars);
    result = $_4wnjwo16tjfcjbcoq.match(editor, [
      $_6rg8ld16sjfcjbcon.element(elements[0], contextToolbarsPredicateIds),
      $_fcjjmw16yjfcjbcp3.textSelection('text'),
      $_fcjjmw16yjfcjbcp3.emptyTextBlock(elements, 'insert'),
      $_6rg8ld16sjfcjbcon.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_4wnjwo16tjfcjbcoq.match(editor, [$_fcjjmw16yjfcjbcp3.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_cl1v5v16zjfcjbcp6.load(editor, function () {
  ...
  var $_67u6nr16njfcjbcoa = { renderUI: renderUI };
  ...
  var never$1 = $_8cwokk17ajfcjbcqc.never;
  var always$1 = $_8cwokk17ajfcjbcqc.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_8cwokk17ajfcjbcqc.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_8r25v317hjfcjbcrf.parseBox(settings.border);
      self.paddingBox = $_8r25v317hjfcjbcrf.parseBox(settings.padding);
      self.marginBox = $_8r25v317hjfcjbcrf.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_fiz1wx17pjfcjbcs5.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_8r25v317hjfcjbcrf.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_8r25v317hjfcjbcrf.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_8r25v317hjfcjbcrf.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_akwdhs17ojfcjbcs4.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_fiz1wx17pjfcjbcs5.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_fiz1wx17pjfcjbcs5.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_bmu92517qjfcjbcsb = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_fiz1wx17pjfcjbcs5.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_fiz1wx17pjfcjbcs5.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_4gcupn178jfcjbcq1.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_4gcupn178jfcjbcq1.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_8r25v317hjfcjbcrf.parseBox(self.settings.border);
          ...
          self.borderBox = $_8r25v317hjfcjbcrf.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_67u6nr16njfcjbcoa.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_7yl4k716mjfcjbco6 = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_vxi7f189jfcjbcv1.resolve(name, scope);
  };
  ...
  var $_d9h3zf188jfcjbcuv = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_d9h3zf188jfcjbcuv.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_6c8hli186jfcjbcuo = { blobToBase64: blobToBase64 };
  ...
  var $_40t4go18cjfcjbcv5 = { pickFile: pickFile };
  ...
  var $_3s0aej18ejfcjbcva = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_72ypls18gjfcjbcvg.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_72ypls18gjfcjbcvg.resolve(dom, bookmark));
  };
  ...
  var $_ctux9818fjfcjbcvd = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_3s0aej18ejfcjbcva.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_ctux9818fjfcjbcvd.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_67f3te18djfcjbcv7.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_40t4go18cjfcjbcv5.pickFile().then(function (files) {
          var blob = files[0];
          $_6c8hli186jfcjbcuo.blobToBase64(blob).then(function (base64) {
            $_67f3te18djfcjbcv7.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_67f3te18djfcjbcv7.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_4eucv8185jfcjbcul = { addToEditor: addToEditor };
  ...
  var $_qp0lh18kjfcjbcvw = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_b12you18mjfcjbcw5.isAbsolute(href) && $_b12you18mjfcjbcw5.isDomainLike(href) ? askAboutPrefix(editor, href) : global$13.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_67f3te18djfcjbcv7.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_67f3te18djfcjbcv7.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_cnxvpc18ljfcjbcw1 = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_7uw29l174jfcjbcpk.isArray(items)) {
      return items;
    } else if ($_7uw29l174jfcjbcpk.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_7uw29l174jfcjbcpk.isFunction(button)) {
            button = button();
          }
  ...
  var $_g6m21818njfcjbcw8 = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_g6m21818njfcjbcw8.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_g6m21818njfcjbcw8.create(editor, 'text', $_ai8lh8171jfcjbcpd.getTextSelectionToolbarItems(editor)),
        $_g6m21818njfcjbcw8.create(editor, 'insert', $_ai8lh8171jfcjbcpd.getInsertToolbarItems(editor)),
        $_cnxvpc18ljfcjbcw1.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_ai8lh8171jfcjbcpd.getPositionHandler(editor);
      contentAreaRect = $_e8c7z116ujfcjbcou.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_e34w8y175jfcjbcpo.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_e34w8y175jfcjbcpo.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_qp0lh18kjfcjbcvw.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_e34w8y175jfcjbcpo.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_e8c7z116ujfcjbcou.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_e34w8y175jfcjbcpo.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_e34w8y175jfcjbcpo.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_g2wa0r170jfcjbcp9.fireBeforeRenderUI(editor);
  ...
  var $_2qa4a919ajfcjbczd = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_8cwokk17ajfcjbcqc.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_rv3jp19bjfcjbczf = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_7fsons19fjfcjbd03 = { cached: cached };

  var $_344y3p19hjfcjbd08 = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_344y3p19hjfcjbd08.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_344y3p19hjfcjbd08.ELEMENT);
  var isText = isType$1($_344y3p19hjfcjbd08.TEXT);
  var isDocument = isType$1($_344y3p19hjfcjbd08.DOCUMENT);
  var $_avs9fn19gjfcjbd05 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_avs9fn19gjfcjbd05.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_7fsons19fjfcjbd03.cached(function () {
    return getBody($_rv3jp19bjfcjbczf.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_rv3jp19bjfcjbczf.fromDom(body);
  };
  var $_4iyl1v19ejfcjbczx = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_4gcupn178jfcjbcq1.each(fields, function (name, i) {
        struct[name] = $_8cwokk17ajfcjbcqc.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_6ytm8l19jjfcjbd1b.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_4gcupn178jfcjbcq1.each(array, function (a) {
      if (!$_6ytm8l19jjfcjbd1b.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_4gcupn178jfcjbcq1.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_72mgee19ojfcjbd1o.validateStrArr('required', required);
    $_72mgee19ojfcjbd1o.validateStrArr('optional', optional);
    $_72mgee19ojfcjbd1o.checkDupes(everything);
    return function (obj) {
      var keys = $_e8wge319njfcjbd1l.keys(obj);
      var allReqd = $_4gcupn178jfcjbcq1.forall(required, function (req) {
        return $_4gcupn178jfcjbcq1.contains(keys, req);
      });
      if (!allReqd)
        $_72mgee19ojfcjbd1o.reqMessage(required, keys);
      var unsupported = $_4gcupn178jfcjbcq1.filter(keys, function (key) {
        return !$_4gcupn178jfcjbcq1.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_72mgee19ojfcjbd1o.unsuppMessage(unsupported);
      var r = {};
      $_4gcupn178jfcjbcq1.each(required, function (req) {
        r[req] = $_8cwokk17ajfcjbcqc.constant(obj[req]);
      });
      $_4gcupn178jfcjbcq1.each(optional, function (opt) {
        r[opt] = $_8cwokk17ajfcjbcqc.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_ezp7gz19kjfcjbd1d = {
    immutable: Immutable,
  ...
  var $_bl50nz19pjfcjbd1s = { toArray: toArray };

  var node = function () {
    var f = $_d9h3zf188jfcjbcuv.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_d8syik19vjfcjbd2q.unknown()
    });
  };
  ...
  var $_2ttwbg19ujfcjbd2k = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_8cwokk17ajfcjbcqc.constant(edge),
    chrome: $_8cwokk17ajfcjbcqc.constant(chrome),
    ie: $_8cwokk17ajfcjbcqc.constant(ie),
    opera: $_8cwokk17ajfcjbcqc.constant(opera),
    firefox: $_8cwokk17ajfcjbcqc.constant(firefox),
    safari: $_8cwokk17ajfcjbcqc.constant(safari)
  };
  ...
  var $_8p62e119wjfcjbd2s = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_8cwokk17ajfcjbcqc.constant(windows$1),
    ios: $_8cwokk17ajfcjbcqc.constant(ios),
    android: $_8cwokk17ajfcjbcqc.constant(android),
    linux: $_8cwokk17ajfcjbcqc.constant(linux),
    osx: $_8cwokk17ajfcjbcqc.constant(osx),
    solaris: $_8cwokk17ajfcjbcqc.constant(solaris),
    freebsd: $_8cwokk17ajfcjbcqc.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_8cwokk17ajfcjbcqc.constant(isiPad),
      isiPhone: $_8cwokk17ajfcjbcqc.constant(isiPhone),
      isTablet: $_8cwokk17ajfcjbcqc.constant(isTablet),
      isPhone: $_8cwokk17ajfcjbcqc.constant(isPhone),
      isTouch: $_8cwokk17ajfcjbcqc.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_8cwokk17ajfcjbcqc.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_4gcupn178jfcjbcq1.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_d8syik19vjfcjbd2q.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_d8syik19vjfcjbd2q.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_9hynki1a1jfcjbd3n.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_9hynki1a1jfcjbd3n.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_9hynki1a1jfcjbd3n.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_9hynki1a1jfcjbd3n.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_dbsg6a1a2jfcjbd3p.head(str).bind(function (head) {
      return $_dbsg6a1a2jfcjbd3p.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_6o0h4z1a0jfcjbd3k.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_6o0h4z1a0jfcjbd3k.contains(uastring, 'edge/') && $_6o0h4z1a0jfcjbd3k.contains(uastring, 'chrome') && $_6o0h4z1a0jfcjbd3k.contains(uastring, 'safari') && $_6o0h4z1a0jfcjbd3k.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_6o0h4z1a0jfcjbd3k.contains(uastring, 'chrome') && !$_6o0h4z1a0jfcjbd3k.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_6o0h4z1a0jfcjbd3k.contains(uastring, 'msie') || $_6o0h4z1a0jfcjbd3k.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_6o0h4z1a0jfcjbd3k.contains(uastring, 'safari') || $_6o0h4z1a0jfcjbd3k.contains(uastring, 'mobile/')) && $_6o0h4z1a0jfcjbd3k.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_6o0h4z1a0jfcjbd3k.contains(uastring, 'iphone') || $_6o0h4z1a0jfcjbd3k.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_8hrc5819zjfcjbd3a = {
    browsers: $_8cwokk17ajfcjbcqc.constant(browsers),
    oses: $_8cwokk17ajfcjbcqc.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_8hrc5819zjfcjbd3a.browsers();
    var oses = $_8hrc5819zjfcjbd3a.oses();
    var browser = $_25fgou19yjfcjbd33.detectBrowser(browsers, userAgent).fold($_2ttwbg19ujfcjbd2k.unknown, $_2ttwbg19ujfcjbd2k.nu);
    var os = $_25fgou19yjfcjbd33.detectOs(oses, userAgent).fold($_8p62e119wjfcjbd2s.unknown, $_8p62e119wjfcjbd2s.nu);
  ...
  var $_7jd89x19tjfcjbd2i = { detect: detect$2 };

  var detect$3 = $_7fsons19fjfcjbd03.cached(function () {
    var userAgent = navigator.userAgent;
    return $_7jd89x19tjfcjbd2i.detect(userAgent);
  });
  var $_4rhu6a19sjfcjbd2d = { detect: detect$3 };

  var ELEMENT = $_344y3p19hjfcjbd08.ELEMENT;
  var DOCUMENT = $_344y3p19hjfcjbd08.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_4gcupn178jfcjbcq1.map(base.querySelectorAll(selector), $_rv3jp19bjfcjbczf.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_rv3jp19bjfcjbczf.fromDom);
  };
  var $_7q2neq1a3jfcjbd3s = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_4gcupn178jfcjbcq1.exists(elements, $_8cwokk17ajfcjbcqc.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_bv3xm919rjfcjbd2b.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_4rhu6a19sjfcjbd2d.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_6rvx3r19qjfcjbd1u = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_7q2neq1a3jfcjbd3s.is
  };

  var owner = function (element) {
    return $_rv3jp19bjfcjbczf.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_rv3jp19bjfcjbczf.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_rv3jp19bjfcjbczf.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_rv3jp19bjfcjbczf.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_4gcupn178jfcjbcq1.findIndex(kin, function (elem) {
        return $_6rvx3r19qjfcjbd1u.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_6ytm8l19jjfcjbd1b.isFunction(isRoot) ? isRoot : $_8cwokk17ajfcjbcqc.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_rv3jp19bjfcjbczf.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_4gcupn178jfcjbcq1.filter(elements, function (x) {
        return !$_6rvx3r19qjfcjbd1u.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_rv3jp19bjfcjbczf.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_rv3jp19bjfcjbczf.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_rv3jp19bjfcjbczf.fromDom);
  };
  var prevSiblings = function (element) {
    return $_4gcupn178jfcjbcq1.reverse($_bl50nz19pjfcjbd1s.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_bl50nz19pjfcjbd1s.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_4gcupn178jfcjbcq1.map(dom.childNodes, $_rv3jp19bjfcjbczf.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_rv3jp19bjfcjbczf.fromDom);
  };
  ...
  var spot = $_ezp7gz19kjfcjbd1d.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_d6bn3h19ijfcjbd0b = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_4iyl1v19ejfcjbczx.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_4gcupn178jfcjbcq1.filter($_d6bn3h19ijfcjbd0b.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_4gcupn178jfcjbcq1.filter($_d6bn3h19ijfcjbd0b.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_4gcupn178jfcjbcq1.filter($_d6bn3h19ijfcjbd0b.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_4gcupn178jfcjbcq1.each($_d6bn3h19ijfcjbd0b.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_7q2neq1a3jfcjbd3s.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_850jxa19djfcjbczr.ancestors(scope, function (e) {
      return $_7q2neq1a3jfcjbd3s.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_850jxa19djfcjbczr.siblings(scope, function (e) {
      return $_7q2neq1a3jfcjbd3s.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_850jxa19djfcjbczr.children(scope, function (e) {
      return $_7q2neq1a3jfcjbd3s.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_7q2neq1a3jfcjbd3s.all(selector, scope);
  };
  var $_ca6uvd19cjfcjbczp = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_4gcupn178jfcjbcq1.map($_ca6uvd19cjfcjbczp.descendants($_rv3jp19bjfcjbczf.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_2qa4a919ajfcjbczd.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_8cwokk17ajfcjbcqc.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_4gcupn178jfcjbcq1.map($_4gcupn178jfcjbcq1.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_4gcupn178jfcjbcq1.map($_4gcupn178jfcjbcq1.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_4gcupn178jfcjbcq1.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_6ab6gy199jfcjbcyw = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_8cwokk17ajfcjbcqc.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_4gcupn178jfcjbcq1.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_4gcupn178jfcjbcq1.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_4gcupn178jfcjbcq1.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_4gcupn178jfcjbcq1.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_4gcupn178jfcjbcq1.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_6ab6gy199jfcjbcyw.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_6ytm8l19jjfcjbd1b.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_4iyl1v19ejfcjbczx.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_rv3jp19bjfcjbczf.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_rv3jp19bjfcjbczf.fromDom(element.parentNode), function (x) {
      return !$_6rvx3r19qjfcjbd1u.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_4gcupn178jfcjbcq1.find(scope.dom().childNodes, $_8cwokk17ajfcjbcqc.compose(predicate, $_rv3jp19bjfcjbczf.fromDom));
    return result.map($_rv3jp19bjfcjbczf.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_rv3jp19bjfcjbczf.fromDom(element.childNodes[i])))
          return Option.some($_rv3jp19bjfcjbczf.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_7q2neq1a3jfcjbd3s.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_9f4o0j1a9jfcjbd4s.ancestor(scope, function (e) {
      return $_7q2neq1a3jfcjbd3s.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_9f4o0j1a9jfcjbd4s.sibling(scope, function (e) {
      return $_7q2neq1a3jfcjbd3s.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_9f4o0j1a9jfcjbd4s.child(scope, function (e) {
      return $_7q2neq1a3jfcjbd3s.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_7q2neq1a3jfcjbd3s.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_7q2neq1a3jfcjbd3s.is, ancestor$1, scope, selector, isRoot);
  };
  var $_6lvd621a8jfcjbd4p = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_f3qwig1acjfcjbd5m.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_f3qwig1acjfcjbd5m.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_f3qwig1acjfcjbd5m.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_f3qwig1acjfcjbd5m.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    global$4.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_f3qwig1acjfcjbd5m.postRenderFormat(editor, name)
      });
    });
  };
  var $_3mivs1abjfcjbd5j = { register: register };
  ...
  var $_4ke5wz1adjfcjbd5o = { register: register$1 };
  ...
  var $_2kplsh1aejfcjbd5s = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_f3qwig1acjfcjbd5m.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_8q6pyx1afjfcjbd5y = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_f3qwig1acjfcjbd5m.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return global$4.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_f3qwig1acjfcjbd5m.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_5mczse1agjfcjbd64 = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_4gcupn178jfcjbcq1.flatten(global$4.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_4gcupn178jfcjbcq1.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_4gcupn178jfcjbcq1.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_46cdz81ahjfcjbd68 = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    global$4.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_f3qwig1acjfcjbd5m.postRenderFormat(editor, name),
        onclick: $_f3qwig1acjfcjbd5m.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_f3qwig1acjfcjbd5m.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_gdhxsi1aijfcjbd6e = { register: register$6 };
  ...
  var $_10sq161ajjfcjbd6h = { register: register$7 };
  ...
  var $_9zndbt1akjfcjbd6l = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_6lvd621a8jfcjbd4p.descendant($_rv3jp19bjfcjbczf.fromDom(document.body), editor.settings.ui_container).fold($_8cwokk17ajfcjbcqc.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_5mczse1agjfcjbd64.register(editor);
    $_3mivs1abjfcjbd5j.register(editor);
    $_gdhxsi1aijfcjbd6e.register(editor);
    $_10sq161ajjfcjbd6h.register(editor);
    $_2kplsh1aejfcjbd5s.register(editor);
    $_4ke5wz1adjfcjbd5o.register(editor);
    $_8q6pyx1afjfcjbd5y.register(editor);
    $_9zndbt1akjfcjbd6l.register(editor);
    $_46cdz81ahjfcjbd68.register(editor);
  };
  var $_6gy3bh1a7jfcjbd4h = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_6ytm8l19jjfcjbd1b.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_6ytm8l19jjfcjbd1b.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_akwdhs17ojfcjbcs4,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_acc438182jfcjbcub,
      Panel: Panel,
      Movable: $_bmu92517qjfcjbcsb,
      Resizable: $_39whvy183jfcjbcuf,
      ...
      FormatControls: $_6gy3bh1a7jfcjbd4h,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_6gy3bh1a7jfcjbd4h.setup(editor);
    $_4eucv8185jfcjbcul.addToEditor(editor, panel);
    return $_7yl4k716mjfcjbco6.get(editor, panel);
  });
  function Theme () {
  }

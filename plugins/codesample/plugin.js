...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_5upy4h9pjfcjb1kb.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_7ais8o9ljfcjb1iw.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_b4pbee9njfcjb1iz.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_f6piei9qjfcjb1kd = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_awamdt9kjfcjb1it = {
    open: function (editor) {
      var minWidth = $_7ais8o9ljfcjb1iw.getDialogMinWidth(editor);
      var minHeight = $_7ais8o9ljfcjb1iw.getDialogMinHeight(editor);
      var currentLanguage = $_f6piei9qjfcjb1kd.getCurrentLanguage(editor);
      var currentLanguages = $_f6piei9qjfcjb1kd.getLanguages(editor);
      var currentCode = $_b4pbee9njfcjb1iz.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_b4pbee9njfcjb1iz.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_5upy4h9pjfcjb1kb.isCodeSample(node)) {
        $_awamdt9kjfcjb1it.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_dl2t159jjfcjb1ir = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_5upy4h9pjfcjb1kb.trimArg($_5upy4h9pjfcjb1kb.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_5upy4h9pjfcjb1kb.trimArg($_5upy4h9pjfcjb1kb.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_8cmk7a9rjfcjb1kh = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_7ais8o9ljfcjb1iw.getContentCss(editor);
  ...
  var $_bl04bc9sjfcjb1kk = { loadCss: loadCss };
  ...
  var $_9dyw099tjfcjb1km = { register: register$1 };

  var addedInlineCss = Cell(false);
  global$1.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_8cmk7a9rjfcjb1kh.setup(editor);
    $_9dyw099tjfcjb1km.register(editor);
    $_dl2t159jjfcjb1ir.register(editor);
    editor.on('init', function () {
      $_bl04bc9sjfcjb1kk.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_5upy4h9pjfcjb1kb.isCodeSample(ev.target)) {
        $_awamdt9kjfcjb1it.open(editor);
      }
    });
  });

...
var help = (function () {
  ...
  var never$1 = $_2179o3asjfcjb1q4.never;
  var always$1 = $_2179o3asjfcjb1q4.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_2179o3asjfcjb1q4.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_drbhxpaujfcjb1q9 = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_gwdeqaqjfcjb1po.map($_drbhxpaujfcjb1q9.shortcuts, function (shortcut) {
  ...
  var $_9z9ocmapjfcjb1pe = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_dz0e45azjfcjb1r3.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_dz0e45azjfcjb1r3.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_dz0e45azjfcjb1r3.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_dz0e45azjfcjb1r3.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_901nq6b0jfcjb1r5.head(str).bind(function (head) {
      return $_901nq6b0jfcjb1r5.tail(str).map(function (tail) {
  ...
  var $_191djeb1jfcjb1r8 = { urls: urls };

  var makeLink = $_2179o3asjfcjb1q4.curry($_92k9qsayjfcjb1qx.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_gwdeqaqjfcjb1po.find($_191djeb1jfcjb1r8.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_4qwubgaxjfcjb1qt.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_gwdeqaqjfcjb1po.filter(keys, $_2179o3asjfcjb1q4.not($_2179o3asjfcjb1q4.curry($_gwdeqaqjfcjb1po.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_gwdeqaqjfcjb1po.map(pluginKeys, function (key) {
  ...
  var $_9zbsciawjfcjb1qf = { makeTab: makeTab$1 };
  ...
  var $_4pcn8b2jfcjb1rb = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_9z9ocmapjfcjb1pe.makeTab(),
          $_9zbsciawjfcjb1qf.makeTab(editor)
        ],
        buttons: $_4pcn8b2jfcjb1rb.makeRow(),
  ...
  var $_7vs3j9aojfcjb1pb = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_7vs3j9aojfcjb1pb.open(editor, pluginUrl));
  };
  var $_dv0e4sanjfcjb1p8 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_7vs3j9aojfcjb1pb.open(editor, pluginUrl)
    });
  ...
  var $_4zrm55b4jfcjb1re = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_4zrm55b4jfcjb1re.register(editor, pluginUrl);
    $_dv0e4sanjfcjb1p8.register(editor, pluginUrl);

...
var emoticons = (function () {
  ...
  var $_dacfoqajjfcjb1oo = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_dacfoqajjfcjb1oo.getHtml(pluginUrl);
  ...
  var $_b3cyfbaijfcjb1ol = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_b3cyfbaijfcjb1ol.register(editor, pluginUrl);
  });
  function Plugin () {
  }

...
var toc = (function () {
  ...
  var $_8me148r8jfcjb6jy = { create: create };

  var tocId = $_8me148r8jfcjb6jy.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_2p34rcr7jfcjb6jw.getTocClass(editor);
    var headerTag = $_2p34rcr7jfcjb6jw.getTocHeader(editor);
    var selector = generateSelector($_2p34rcr7jfcjb6jw.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_2p34rcr7jfcjb6jw.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_2p34rcr7jfcjb6jw.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_ee6n7mr3jfcjb6jq.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_ee6n7mr3jfcjb6jq.updateToc(editor);
    });
  };
  var $_76tv0wr2jfcjb6jn = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_2p34rcr7jfcjb6jw.getTocClass(editor);
  ...
  var $_en6n5sr9jfcjb6k0 = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_ee6n7mr3jfcjb6jq.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_2p34rcr7jfcjb6jw.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_evg5zorajfcjb6k3 = { register: register$1 };

  global.add('toc', function (editor) {
    $_76tv0wr2jfcjb6jn.register(editor);
    $_evg5zorajfcjb6k3.register(editor);
    $_en6n5sr9jfcjb6k0.setup(editor);
  });
  function Plugin () {
  }

...
var contextmenu = (function () {
  ...
  var $_3t4kq3a4jfcjb1n0 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_d8708pa3jfcjb1mx.getContextMenu(editor);
  ...
  var $_5g4xr3a7jfcjb1n5 = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_d8708pa3jfcjb1mx.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_5g4xr3a7jfcjb1n5.show(editor, $_3t4kq3a4jfcjb1n0.getPos(editor, e), visibleState, menu);
    });
  };
  var $_402k4na2jfcjb1mw = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_402k4na2jfcjb1mw.setup(editor, visibleState, menu);
    return $_6hd2p5a1jfcjb1mu.get(visibleState);
  });
  function Plugin () {
  }

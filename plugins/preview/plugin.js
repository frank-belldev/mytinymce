...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_51rozdigjfcjb38d.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_51rozdigjfcjb38d.getPreviewDialogWidth(editor);
    var dialogHeight = $_51rozdigjfcjb38d.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_1zxc4yihjfcjb38g.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_6wkveqiejfcjb38a = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_6wkveqiejfcjb38a.open(editor);
    });
  };
  var $_5up2n6idjfcjb387 = { register: register };
  ...
  var $_6zjt84ijjfcjb38l = { register: register$1 };

  global.add('preview', function (editor) {
    $_5up2n6idjfcjb387.register(editor);
    $_6zjt84ijjfcjb38l.register(editor);
  });
  function Plugin () {
  }

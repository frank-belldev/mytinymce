...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_9m1nsl8ejfcjb18k.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_9m1nsl8ejfcjb18k.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_9m1nsl8ejfcjb18k.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_9m1nsl8ejfcjb18k.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_9m1nsl8ejfcjb18k.getAutoResizeBottomMargin(editor);
    ...
    if ($_9m1nsl8ejfcjb18k.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_263qay8bjfcjb18f.resize(editor, oldSize);
    });
  };
  var $_ebk8828ajfcjb18c = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_ebk8828ajfcjb18c.register(editor, oldSize);
      $_263qay8bjfcjb18f.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }

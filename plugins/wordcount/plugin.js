...
var wordcount = (function () {
  ...
  var $_aul8pcsejfcjb6px = {
    each: each,
    map: map
  };

  var SETS$1 = $_gdt4r4scjfcjb6pq.SETS;
  var OTHER = $_gdt4r4scjfcjb6pq.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_aul8pcsejfcjb6px.map(string.split(''), memoized);
  };
  var $_fefjm0sdjfcjb6pu = { classify: classify };

  var ci = $_gdt4r4scjfcjb6pq.characterIndices;
  ...
  var $_1sdzesfjfcjb6q0 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_gdt4r4scjfcjb6pq.EMPTY_STRING;
  var WHITESPACE$1 = $_gdt4r4scjfcjb6pq.WHITESPACE;
  var PUNCTUATION$1 = $_gdt4r4scjfcjb6pq.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_fefjm0sdjfcjb6pu.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_1sdzesfjfcjb6q0.isWordBoundary(map, i)) {
  ...
  var $_807910sbjfcjb6ph = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_807910sbjfcjb6ph.getWords(getTextContent(editor)).length;
  };
  var $_bxt47ssajfcjb6pf = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_bxt47ssajfcjb6pf.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_95j81gs9jfcjb6pc = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_bxt47ssajfcjb6pf.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_9oik5nsgjfcjb6q5 = { setup: setup };

  global.add('wordcount', function (editor) {
    $_9oik5nsgjfcjb6q5.setup(editor);
    return $_95j81gs9jfcjb6pc.get(editor);
  });
  function Plugin () {
  }

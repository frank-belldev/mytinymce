...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_288o56efjfcjb2hf.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_288o56efjfcjb2hf.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_288o56efjfcjb2hf.getSelectorConverter(editor)) {
      selectorConverter = $_288o56efjfcjb2hf.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_288o56efjfcjb2hf.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_288o56efjfcjb2hf.getCssGroups(editor));
      ...
      if (!$_288o56efjfcjb2hf.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_288o56efjfcjb2hf.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_8azac5eajfcjb2h3.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_81nsope9jfcjb2gz = { get: get };

  global.add('importcss', function (editor) {
    $_8azac5eajfcjb2h3.setup(editor);
    return $_81nsope9jfcjb2gz.get(editor);
  });
  function Plugin () {
  }
